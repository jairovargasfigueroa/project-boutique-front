'use client';
import { Box, Typography, Button, CircularProgress, Alert, Card, CardContent, Divider } from '@mui/material';
...
export default function CheckoutPage() {
  ...
  const { crearVenta, loading, error } = useVentas();
  ...
  const handleConfirmarPedido = async () => {
    ...
    try {
      ...
      const clienteId = datosCliente?.cliente ? parseInt(datosCliente.cliente) : null;
